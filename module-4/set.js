...
const countCommonFriendsSlowly = (usersA, usersB) => {
  ...
  return {
    countCommonFriends: commonFriends.length,
    timeTookToFinish: endTime - startTime,
  };
};

// console.log(countCommonFriendsSlowly(usersA, usersB))


const countCommonFriendsFast = (usersA, usersB) => {
  const startTime = performance.now();
  const commonFriends = [];
...
// console.log(countCommonFriendsFast(usersA, usersB));
